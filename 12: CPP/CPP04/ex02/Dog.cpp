...
/*   Updated: 2024/05/22 20:38:53 by waziz            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Dog::Dog(std::string newType) : AAnimal(newType), _brain(new Brain("Brain")) {
    Type = newType;
    std::cout << "Dog : Custom constructor called" << std::endl;
}

Dog::Dog(const Dog& other) : AAnimal(), _brain(new Brain("Brain")) {
    *this = other;
