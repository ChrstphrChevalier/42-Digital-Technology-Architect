...
/*   Updated: 2024/05/22 20:38:38 by waziz            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Cat::Cat(std::string newType) : AAnimal(newType), _brain(new Brain("Brain")) {
    Type = newType;
    std::cout << "Cat : Custom constructor called" << std::endl;
}

Cat::Cat(const Cat& other) : AAnimal(), _brain(new Brain("Brain")) {
    *this = other;
